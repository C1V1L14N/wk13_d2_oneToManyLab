...
- Be able to implement one-to-many and many-to-many relationships between com.example.OneToManyToManyLab.models with Spring JPA + Hibernate
...
Implement the following com.example.OneToManyToManyLab.models to achieve the above relationships:

An Employee must:

- have a first name
- have last name
- have an com.example.OneToManyToManyLab.models.project.com.example.OneToManyToManyLab.employee number
...
Draw a diagram modelling the relationships between the com.example.OneToManyToManyLab.models. Study the previous two lessons on **one-to-many** and **many-to-many** to help you.
